  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-thy-ink">Availability Management</h1>
      ...
      <div className="bg-thy-surface p-5 sm:p-6 rounded-2xl shadow-sm border border-thy-ink/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
        ...
        <button
          ...
          className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all w-full sm:w-auto min-h-11 ${
            isAvailable && !vacationMode
      ...
      <div className="bg-thy-surface p-5 sm:p-6 rounded-2xl shadow-sm border border-thy-ink/10 space-y-4">
      ...
      <div className="bg-thy-surface p-5 sm:p-6 rounded-2xl shadow-sm border border-thy-ink/10 flex items-center justify-between gap-4">
        <div>
